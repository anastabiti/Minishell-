...
#    Updated: 2022/06/20 07:26:17 by atabiti          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
./libft/ft_putstr_fd.c           ./libft/ft_putendl_fd.c  ./exec/ftpipe.c  ./exec/ft_one_command.c  ./exec/ft_multi_cmds.c    ./libft/ft_split.c  ./libft/ft_strdup.c   ./libft/ft_memcpy.c ./libft/ft_strlcpy.c   ./libft/ft_memmove.c    ./exec/ft_here_doc.c        \
...
./libft/ft_putstr_fd.o           ./libft/ft_putendl_fd.o  ./exec/ftpipe.o ./exec/ft_one_command.o  ./exec/ft_multi_cmds.o ./libft/ft_split.o ./libft/ft_strdup.o ./libft/ft_memcpy.o   ./libft/ft_strlcpy.o ./libft/ft_memmove.o ./exec/ft_here_doc.o\
